...
def main() -> int:
    ...
    if args.inspect_only:
        ...
        path = OUT / f"inspect-code-parrainage-{args.program}.json"
    ...
    pre = preflight_live_plan("code-parrainage", plan, program=args.program)
    if pre.get("abort"):
        ...
        record_live_success("code-parrainage") if pre.get("ok") else record_live_failure(
            "code-parrainage", pre.get("error") or "preflight"
        )
