...
FIELD_ALIASES: dict[str, str] = {
    ...
    # AGENTS.md documents "récompense filleul"/"récompense parrain" alongside
    # the "gain ..." forms; both must resolve to the same backend field.
    "recompense filleul": "referee_reward",
    "récompense filleul": "referee_reward",
    "gain parrain": "referrer_reward",
    "recompense parrain": "referrer_reward",
    ...
    "trade min": "trade_min",
    "trade_min": "trade_min",
    # AGENTS.md documents "minimum de trade" as a supported verb; without this
    # alias the documented phrasing was rejected with a bare parse_error.
    "minimum de trade": "trade_min",
    "minimum trade": "trade_min",
    "transaction": "transaction_count",
    "transactions": "transaction_count",
    "transaction_count": "transaction_count",
    "nombre de transactions": "transaction_count",
    "nombre de transaction": "transaction_count",
    "nombre transactions": "transaction_count",
    ...
    "type de recompense": "reward_type",
    "type de récompense": "reward_type",
    "type récompense": "reward_type",
    "title": "title",
    "titre": "title",
}
